...
than in this guide. ``LLM/performance/SPEED_UP.md`` documents each change, the measurements
behind it and the reasoning; ``LLM/performance/SPEED_UP_REVIEW.md`` catalogues every proposal
